...
public class JPAUnitTestCase {
	...
	public void hhh123Test() throws Exception {
		...
		final Query query2 = entityManager.createNamedQuery( "EdiCorpAction.findByEventTypeAndDate" )
				.setParameter( "eventCD", Arrays.asList( EdiActionType.LSTAT, EdiActionType.ANN ) )
				.setParameter( "date1", "123" );
		assertNotNull( query2.getResultList());
